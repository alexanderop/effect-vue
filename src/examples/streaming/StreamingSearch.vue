...
import ManualPattern from './ManualPattern.vue'
import PullPattern from './PullPattern.vue'
import ScanPattern from './ScanPattern.vue'
...
<template>
  <div class="streaming-shell">
    ...
    <ScanPattern v-if="selected === 'scan'" :query="query" />
    <PullPattern v-else-if="selected === 'pull'" />
    <ManualPattern v-else :query="query" />
  </div>
</template>
